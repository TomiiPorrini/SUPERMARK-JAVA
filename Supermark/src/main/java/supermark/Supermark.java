...
public class Supermark {
	...
	public static void main(String args[]) {
		//Inserta nuevo usuario noAdmin
//		Usuario nuevoUsuario = new Usuario();
//		nuevoUsuario.registrarse("'basd'", "'asd'", "'prueba@gmail.com'", "'1234'", "'aaaaaaaaA1'", 1);
//		
//		Usuario loginUsuario = new Usuario();
//		loginUsuario.funlogin("'prueba@gmail.com'", "'aaaaaaaaA1'");
		
		
//		Producto nuevoProducto = new Producto();
//		nuevoProducto.AltaProd("'Alimento para perros'", "'Dogi'", "'2023-01-01'", 100, 10, 1);
		
		Producto ModificarProducto = new Producto();
		ModificarProducto.ModiProd(2, 2, 61);
