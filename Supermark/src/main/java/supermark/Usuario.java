...
public class Usuario {
	...
	public void registrarse(String nombre, String apellido, String email, String dni, String contrasenia,
		...
		try {
			...
			if (Usuario.validar_email(email) && Usuario.validar_contra(contrasenia)) {
		 ...
		 // Credenciales de la BDD
			...
			String PASS = mi_credi.PASS;
			 ...
			 while(rs.next()){
				 ...
				 if ((email.equals(email_tupla)) && (contrasenia.equals(contrasenia_tupla))){
					 xencontrado = true; 
				 }else
	...
	public static boolean validar_contra(String contraseña) {
